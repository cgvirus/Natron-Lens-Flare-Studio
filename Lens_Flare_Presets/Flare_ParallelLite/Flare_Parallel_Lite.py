...
# Hand-written code should be added in a separate file named Flare_Parallel_LiteExt.py
...
try:
    from Flare_Parallel_LiteExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlareParallelLite"

def getLabel():
    return "Flare_Parallel_Lite"
...
def createInstance(app,group):
    ...
    param.setValue(0.6375969648361206, 1)
    ...
    param.setDefaultValue("ParallelLite Flare Developed by")
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.165, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat5")
    if param is not None:
        param.setValueAtTime(0.231, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueVec38")
    if param is not None:
        param.setValueAtTime(0.7912980318069458, 1, 0)
        param.setValueAtTime(0.7912980318069458, 1, 1)
        param.setValueAtTime(0.7912980318069458, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueFloat8")
    if param is not None:
        param.setValueAtTime(0.014, 1, 0)
        del param
    ...
    if param is not None:
        param.setValueAtTime(1, 1, 0)
        param.setValueAtTime(0, 1, 1)
        param.setValueAtTime(0.00121410796418786, 1, 2)
        del param
    ...
    if param is not None:
        ...
        param.setValueAtTime(0.0284260381013155, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec318")
    if param is not None:
        param.setValueAtTime(0.1195384338498116, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0.04817181825637817, 1, 2)
        del param
    ...
    groupRing.connectInput(0, groupSun_2_2_2)
    groupHoop.connectInput(0, groupAnamorphic_Spots_3)
    groupAnamorphic_ghost_Single.connectInput(0, groupRing)
    groupAnamorphic_Spots_3.connectInput(0, groupAnamorphic_ghost_Single)
    ...
    del param
    try:
        extModule = sys.modules["Flare_Parallel_LiteExt"]
    except KeyError:
        extModule = None
