...
# Hand-written code should be added in a separate file named Flare_DevilEyeExt.py
...
try:
    from Flare_DevilEyeExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.Flare_DevilEye"

def getLabel():
    return "Flare_DevilEye"
...
def createInstance(app,group):
    ...
    param.setValue(236, 0)
    param.setValue(593, 1)
    ...
    param.setAddNewLine(True)
    param.setAnimationEnabled(True)
    param.setValue(0.5840784907341003, 1)
    param.setValue(0.5840784907341003, 2)
    ...
    param.setDefaultValue("DevilEye Flare Developed by")
    ...
    param = lastNode.getParam("paramValueFloat13")
    if param is not None:
        param.setValueAtTime(0.536, 1, 0)
        del param
    ...
    if param is not None:
        param.setValueAtTime(0, 1, 0)
        param.setValueAtTime(0.08228270709514618, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    groupGlimmer_2.connectInput(0, groupSun_2_2)
    ...
    del param
    try:
        extModule = sys.modules["Flare_DevilEyeExt"]
    except KeyError:
        extModule = None
