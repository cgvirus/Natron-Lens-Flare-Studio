...
# Hand-written code should be added in a separate file named Flare_CrytalExt.py
...
try:
    from Flare_CrytalExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlareCrystal"

def getLabel():
    return "Flare_Crystal"
...
def createInstance(app,group):
    ...
    param.setValue(0.6444797515869141, 2)
    ...
    param.setDefaultValue("Crystal Flare Developed by")
    ...
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">Glow</font>")
        del param
    ...
    # Start of node "flare_3"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare_3")
    lastNode.setLabel("flare_3")
    lastNode.setPosition(184, 258)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare_3 = lastNode
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.134, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat5")
    if param is not None:
        param.setValueAtTime(0.589, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat7")
    if param is not None:
        param.setValueAtTime(1.166, 1, 0)
        del param
    ...
    param = lastNode.getParam("imageShaderPreset")
    if param is not None:
        param.set("Lens Flare Elements/ring_multilayer")
        del param
    ...
    param = lastNode.getParam("userTextArea")
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">RIng</font>")
        del param
    ...
    param = lastNode.getParam("paramValueVec316")
    if param is not None:
        param.setValueAtTime(0.8227858543395996, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec318")
    if param is not None:
        param.setValueAtTime(0.1094617173075676, 1, 0)
        param.setValueAtTime(0, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.031, 1, 0)
        del param
    ...
    # Start of node "flare2_2"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare2_2")
    lastNode.setLabel("flare_2_2")
    lastNode.setPosition(184, 499)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare2_2 = lastNode

    param = lastNode.getParam("mousePosition")
    if param is not None:
        param.setValueAtTime(477, 1, 0)
    ...
    groupflare_3.connectInput(0, groupflare2)
    groupflare_4.connectInput(0, groupflare_3)
    groupflare_5.connectInput(0, groupflare_4)
    groupflare2.connectInput(0, groupflare)
    groupflare2_2.connectInput(0, groupflare_5)
    ...
    del param
    param = groupflare.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupflare_3.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare_3.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare_3.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare_3.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    ...
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupflare2_2.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare2_2.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare2_2.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare2_2.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_CrytalExt"]
    except KeyError:
        extModule = None
