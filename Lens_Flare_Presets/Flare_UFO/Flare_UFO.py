...
# Hand-written code should be added in a separate file named Flare_UFOExt.py
...
try:
    from Flare_UFOExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlareUFO"
...
def getPluginDescription():
    return "A Abstract UFO Lite Flare"
...
def createInstance(app,group):
    ...
    param.setValue(193, 0)
    param.setValue(550, 1)
    ...
    param.setValue(0.9822505712509155, 1)
    ...
    param.setDefaultValue("UFO Flare Developed by")
    ...
    # Start of node "Glimer1"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("Glimer1")
    lastNode.setLabel("Glimer1")
    lastNode.setPosition(181, 243)
    lastNode.setSize(104, 32)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupGlimer1 = lastNode
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.221, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.191, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat5")
    if param is not None:
        param.setValueAtTime(0.457, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat7")
    if param is not None:
        param.setValueAtTime(0.885, 1, 0)
        del param
    ...
    param = lastNode.getParam("mousePosition")
    if param is not None:
        param.setValueAtTime(203, 1, 0)
        param.setValueAtTime(547, 1, 1)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.028, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.027, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.469, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat5")
    if param is not None:
        param.setValueAtTime(0.887, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat7")
    if param is not None:
        param.setValueAtTime(-0.544, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.827, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.413, 1, 0)
        del param
    ...
    groupCausticGhosts.connectInput(0, groupStar)
    groupGlimer1.connectInput(0, groupCausticGhosts)
    groupStar.connectInput(0, groupBG_Black)
    groupGlimmer2.connectInput(0, groupGlimer1)
    groupHoop.connectInput(0, groupGlimmer2)
    ...
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupGlimer1.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupGlimer1.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupGlimer1.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupGlimer1.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_UFOExt"]
    except KeyError:
        extModule = None
