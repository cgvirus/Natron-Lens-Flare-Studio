...
# Hand-written code should be added in a separate file named Flare_PrismExt.py
...
try:
    from Flare_PrismExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlarePrism"
...
def createInstance(app,group):
    ...
    param.setValue(167, 0)
    param.setValue(562, 1)
    ...
    param.setDefaultValue("Prism Flare Developed by")
    ...
    param = lastNode.getParam("paramValueFloat5")
    if param is not None:
        param.setValueAtTime(0.112, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.493, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.417, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat7")
    if param is not None:
        param.setValueAtTime(-1.054, 1, 0)
        del param
    ...
    param = lastNode.getParam("imageShaderPreset")
    if param is not None:
        param.set("Lens Flare Elements/glimmer_Multilayer")
        del param
    ...
    if param is not None:
        param.setValueAtTime(1, 1, 0)
        param.setValueAtTime(0.1195384338498116, 1, 1)
        param.setValueAtTime(0.1274376958608627, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec314")
    if param is not None:
        param.setValueAtTime(0.09530748426914215, 1, 0)
        param.setValueAtTime(0.590618908405304, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(1.302, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.415, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat7")
    if param is not None:
        param.setValueAtTime(1.227, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueVec39")
    if param is not None:
        param.setValueAtTime(0.02217388339340687, 1, 0)
        param.setValueAtTime(1, 1, 1)
    ...
    param = lastNode.getParam("paramValueVec310")
    if param is not None:
        param.setValueAtTime(0.07421357929706573, 1, 0)
        param.setValueAtTime(0.04666508361697197, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    groupMiris_Single.connectInput(0, groupglimmer)
    groupCaustic_Ghost.connectInput(0, groupMiris_Single)
    groupHoop.connectInput(0, groupCaustic_Ghost)
    ...
    del param
    try:
        extModule = sys.modules["Flare_PrismExt"]
    except KeyError:
        extModule = None
