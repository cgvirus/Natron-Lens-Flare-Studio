...
# Hand-written code should be added in a separate file named Flare_ConspiredExt.py
...
try:
    from Flare_ConspiredExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FalreConspired"

def getLabel():
    return "Flare_Conspired"
...
def createInstance(app,group):
    ...
    param.setAddNewLine(True)
    param.setAnimationEnabled(True)
    param.setValue(0.6104956865310669, 0)
    param.setValue(0.6724432110786438, 2)
    ...
    param.setDefaultValue("Flare Conspired Developed by")
    ...
    # Start of node "flare_4"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare_4")
    lastNode.setLabel("flare_4")
    lastNode.setPosition(184, 211)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare_4 = lastNode

    param = lastNode.getParam("mousePosition")
    if param is not None:
        param.setValueAtTime(487, 1, 0)
        param.setValueAtTime(702, 1, 1)
        del param
    ...
    param = lastNode.getParam("paramValueFloat8")
    if param is not None:
        param.setValueAtTime(0.008, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueVec316")
    if param is not None:
        param.setValueAtTime(0.09758736193180084, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0.3419144451618195, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec318")
    if param is not None:
        param.setValueAtTime(0.3094689548015594, 1, 0)
        param.setValueAtTime(0.3185468316078186, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">Anamorphic Spot</font>")
        del param

    del lastNode
    # End of node "flare_4"

    # Start of node "flare_5"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare_5")
    lastNode.setLabel("flare_5")
    lastNode.setPosition(184, 320)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare_5 = lastNode
    ...
    param = lastNode.getParam("userTextArea")
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">Casutic Ghost</font>")
        del param

    del lastNode
    # End of node "flare_5"

    # Start of node "flare2"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare2")
    lastNode.setLabel("flare_2")
    lastNode.setPosition(184, 110)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare2 = lastNode

    param = lastNode.getParam("mousePosition")
    if param is not None:
        param.setValueAtTime(780, 1, 0)
        param.setValueAtTime(520, 1, 1)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.039, 1, 0)
        del param
    ...
    param = lastNode.getParam("userTextArea")
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">Star</font>")
        del param

    del lastNode
    # End of node "flare2"

    # Start of node "flare_6"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare_6")
    lastNode.setLabel("flare_6")
    lastNode.setPosition(184, 424)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare_6 = lastNode

    param = lastNode.getParam("mousePosition")
    if param is not None:
        param.setValueAtTime(220, 1, 0)
        param.setValueAtTime(661, 1, 1)
        del param
    ...
    param = lastNode.getParam("paramValueFloat13")
    if param is not None:
        param.setValueAtTime(0.211, 1, 0)
        del param
    ...
    param = lastNode.getParam("userTextArea")
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">Anamorphic</font>")
        del param

    del lastNode
    # End of node "flare_6"

    # Start of node "flare_7"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare_7")
    lastNode.setLabel("flare_7")
    lastNode.setPosition(184, 529)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare_7 = lastNode

    param = lastNode.getParam("mousePosition")
    if param is not None:
        param.setValueAtTime(479, 1, 0)
        param.setValueAtTime(553, 1, 1)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.914, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.681, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat7")
    if param is not None:
        param.setValueAtTime(-0.898, 1, 0)
        del param
    ...
    param = lastNode.getParam("imageShaderPreset")
    if param is not None:
        param.set("Lens Flare Elements/hoop_MultiLAyer")
        del param
    ...
    param = lastNode.getParam("userTextArea")
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">Hoop</font>")
        del param

    del lastNode
    # End of node "flare_7"

    # Start of node "flare_7_2"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("flare_7_2")
    lastNode.setLabel("flare_7_2")
    lastNode.setPosition(184, 639)
    lastNode.setSize(104, 55)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupflare_7_2 = lastNode

    param = lastNode.getParam("mousePosition")
    if param is not None:
        param.setValueAtTime(824, 1, 0)
        param.setValueAtTime(659, 1, 1)
        del param
    ...
    param = lastNode.getParam("paramValueVec316")
    if param is not None:
        param.setValueAtTime(0.3515326380729675, 1, 0)
        param.setValueAtTime(0.3813261091709137, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec317")
    if param is not None:
        param.setValueAtTime(0.9215819239616394, 1, 0)
        param.setValueAtTime(0.2383975833654404, 1, 1)
        param.setValueAtTime(0.9473065733909607, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec318")
    if param is not None:
        param.setValueAtTime(0.9473065733909607, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    groupflare_4.connectInput(0, groupflare2)
    groupflare_5.connectInput(0, groupflare_4)
    groupflare2.connectInput(0, groupBG_Black)
    groupflare_6.connectInput(0, groupflare_5)
    groupflare_7.connectInput(0, groupflare_6)
    groupflare_7_2.connectInput(0, groupflare_7)
    ...
    del param
    param = groupflare_4.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare_4.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare_4.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare_5.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare_5.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare_5.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare_5.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupflare2.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare2.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare2.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare2.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupflare_6.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare_6.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare_6.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare_6.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupflare_7.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare_7.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare_7.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare_7.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupflare_7_2.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupflare_7_2.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupflare_7_2.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupflare_7_2.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_ConspiredExt"]
    except KeyError:
        extModule = None
