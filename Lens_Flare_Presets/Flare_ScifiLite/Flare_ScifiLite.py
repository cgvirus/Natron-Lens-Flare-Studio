...
# Hand-written code should be added in a separate file named Flare_ScifiLiteExt.py
...
try:
    from Flare_ScifiLiteExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlareScifiLite"

def getLabel():
    return "Flare_ScifiLite"
...
def createInstance(app,group):
    ...
    param.setAddNewLine(True)
    param.setAnimationEnabled(True)
    param.setValue(0.3139887750148773, 0)
    param.setValue(0.4341537058353424, 1)
    ...
    param.setDefaultValue("Scifi Lite Flare Developed by")
    ...
    param = lastNode.getParam("paramValueFloat8")
    if param is not None:
        param.setValueAtTime(0.012, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueVec316")
    if param is not None:
        param.setValueAtTime(0.03433980047702789, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0.07036010921001434, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec317")
    if param is not None:
        param.setValueAtTime(0.01228648703545332, 1, 0)
        param.setValueAtTime(0.4341537058353424, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec318")
    if param is not None:
        param.setValueAtTime(0.02315336465835571, 1, 0)
        param.setValueAtTime(0.6038274168968201, 1, 1)
        param.setValueAtTime(0.04666508361697197, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueFloat7")
    if param is not None:
        param.setValueAtTime(0.694, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueVec316")
    if param is not None:
        param.setValueAtTime(0.2195262312889099, 1, 0)
        param.setValueAtTime(0.3467040657997131, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec317")
    if param is not None:
        param.setValueAtTime(0.04518620297312737, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0.7379105091094971, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec318")
    if param is not None:
        param.setValueAtTime(0.2541521489620209, 1, 0)
        param.setValueAtTime(0.6038274168968201, 1, 1)
        param.setValueAtTime(0.2704978585243225, 1, 2)
        del param
    ...
    groupAnamorphic_Spots_2.connectInput(0, groupAnamorphic_Spots_3)
    ...
    groupAnamorphic_Spots_3.connectInput(0, groupStar)
    ...
    del param
    try:
        extModule = sys.modules["Flare_ScifiLiteExt"]
    except KeyError:
        extModule = None
