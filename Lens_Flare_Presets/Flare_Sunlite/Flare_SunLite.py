...
# Hand-written code should be added in a separate file named Flare_SunLiteExt.py
...
try:
    from Flare_SunLiteExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlareSunlite"

def getLabel():
    return "Flare_SunLite"
...
def createInstance(app,group):
    ...
    param.setAddNewLine(True)
    param.setAnimationEnabled(True)
    param.setValue(0.7991028428077698, 1)
    param.setValue(0.4620770514011383, 2)
    ...
    param.setDefaultValue("SunLite Flare Developed by")
    ...
    if param is not None:
        param.setValueAtTime(0.9822505712509155, 1, 0)
        param.setValueAtTime(0.9822505712509155, 1, 1)
        param.setValueAtTime(0.9822505712509155, 1, 2)
        del param
    ...
    if param is not None:
        param.setValueAtTime(0.1499598026275635, 1, 0)
        param.setValueAtTime(0.1499598026275635, 1, 1)
        param.setValueAtTime(0.1499598026275635, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.891, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.271, 1, 0)
        del param
    ...
    if param is not None:
        ...
        param.setValueAtTime(0.6653873324394226, 1, 1)
        param.setValueAtTime(0.6653873324394226, 1, 2)
        del param
    ...
    groupMiris_Single.connectInput(0, grouphoop1)
    ...
    del param
    try:
        extModule = sys.modules["Flare_SunLiteExt"]
    except KeyError:
        extModule = None
