...
# Hand-written code should be added in a separate file named Flare_StreaksExt.py
...
try:
    from Flare_StreaksExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlareStreak"

def getLabel():
    return "Flare_Streaks"
...
def createInstance(app,group):
    ...
    param.setValue(967, 0)
    param.setValue(362, 1)
    ...
    param.setValue(0.8227858543395996, 1)
    ...
    param.setDefaultValue("Straks Flare Developed by")
    ...
    param = lastNode.getParam("paramValueVec315")
    if param is not None:
        param.setValueAtTime(0.4851499795913696, 1, 0)
        param.setValueAtTime(0.7991028428077698, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    if param is not None:
        param.setValueAtTime(1, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0.06301002204418182, 1, 2)
        del param
    ...
    if param is not None:
        param.setValueAtTime(1, 1, 0)
        param.setValueAtTime(0.03433980047702789, 1, 1)
        param.setValueAtTime(0.2622507214546204, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec318")
    if param is not None:
        param.setValueAtTime(0.1651321947574615, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0.1195384338498116, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueFloat12")
    if param is not None:
        param.setValueAtTime(9.800000000000001, 1, 0)
        del param
    ...
    if param is not None:
        ...
        param.setValueAtTime(0.08650046586990356, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec317")
    if param is not None:
        param.setValueAtTime(0.8148466348648071, 1, 0)
        param.setValueAtTime(0.0368894450366497, 1, 1)
    ...
    if param is not None:
        ...
        param.setValueAtTime(0.2961383163928986, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("userTextArea")
    if param is not None:
        param.setValue("<font size=\"6\" color=\"#000000\" face=\"Droid Sans\">Anamorphic Spots</font>")
        del param
    ...
    groupflare_4.connectInput(0, groupBG_Black)
    groupflare_7_2.connectInput(0, groupflare_4)
    ...
    del param
    try:
        extModule = sys.modules["Flare_StreaksExt"]
    except KeyError:
        extModule = None
