...
# Hand-written code should be added in a separate file named Flare_Small_AnamorphicExt.py
...
try:
    from Flare_Small_AnamorphicExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.SmallAnamFlare"

def getLabel():
    return "Flare_Small_Anamorphic"
...
def getPluginDescription():
    return "A Small Anamorphic flare"
...
def createInstance(app,group):
    ...
    param.setAddNewLine(True)
    param.setAnimationEnabled(True)
    param.setValue(0.5332764983177185, 0)
    param.setValue(0.4232677519321442, 2)
    ...
    param.setDefaultValue("Small Anamorphic Flare Developed by")
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.07199999999999999, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.532, 1, 0)
        del param
    ...
    # Start of node "Miris"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("Miris")
    lastNode.setLabel("Miris")
    lastNode.setPosition(182, 427)
    lastNode.setSize(104, 32)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupMiris = lastNode
    ...
    param = lastNode.getParam("paramValueFloat8")
    if param is not None:
        param.setValueAtTime(0.008999999999999999, 1, 0)
        del param
    ...
    if param is not None:
        ...
        param.setValueAtTime(0.2195262312889099, 1, 1)
        param.setValueAtTime(0.2195262312889099, 1, 2)
        del param
    ...
    groupSun_2.connectInput(0, groupMiris)
    ...
    groupMiris.connectInput(0, groupGlimmer_2)
    ...
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    param = groupMiris.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupMiris.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupMiris.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupMiris.getParam("paramValueFloat2")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat2"), 0, 0)
    del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_Small_AnamorphicExt"]
    except KeyError:
        extModule = None
