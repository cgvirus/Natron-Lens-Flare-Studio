...
# Hand-written code should be added in a separate file named Flare_BokehExt.py
...
try:
    from Flare_BokehExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.FlareBokeh"
...
def createInstance(app,group):
    ...
    param.setValue(947, 0)
    param.setValue(232, 1)
    ...
    param.setDefaultValue("Flare Bokeh Developed by")
    ...
    param = lastNode.getParam("paramValueFloat9")
    if param is not None:
        param.setValueAtTime(0.6899999999999999, 1, 0)
        del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_BokehExt"]
    except KeyError:
        extModule = None
